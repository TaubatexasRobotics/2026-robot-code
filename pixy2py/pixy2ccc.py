...
class Pixy2CCC(object):
    ...
    def getBlocks(self, wait=True, sigmap=0xFF, maxBlocks=0xFF):
        ...
        while True:
            ...
            if res == pixy2py.pixy2.Pixy2.PIXY_RESULT_OK:
                ...
                elif self.pixy.type == pixy2py.pixy2.Pixy2.PIXY_TYPE_RESPONSE_ERROR:
                    # Deal with busy and program changing states from Pixy2 (we'll wait).
                    if self.pixy.response_buffer[0] == pixy2py.pixy2.Pixy2.PIXY_RESULT_BUSY:
                        if not wait:
                            return pixy2py.pixy2.Pixy2.PIXY_RESULT_BUSY # New data not available yet.
                    elif self.pixy.response_buffer[0] == pixy2py.pixy2.Pixy2.PIXY_RESULT_PROG_CHANGING:
                        return self.pixy.response_buffer[0]
            else:
                return pixy2py.pixy2.Pixy2.PIXY_RESULT_ERROR
