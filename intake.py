...
class Intake(Subsystem):
    def __init__(self) -> None:
        self.pivot = WPI_VictorSPX(constants.Kintake_pivot_id)
        self.roller = WPI_VictorSPX(constants.Kintake_roller_id)
        self.pivotUp = False
    ...
    def periodic(self) -> None:
        ...
        # SmartDashboard
        SmartDashboard.putNumber("Intake/Pivot", self.pivot.get())
        SmartDashboard.putNumber("Intake/Roller", self.roller.get())
